...
class Artikel extends CI_Controller {
	...
	public function index()
	{
		$data = [
			'link' => 'artikel',
			'title' => 'Artikel'.$this->title,
            'fileScript' => 'artikel.js',
		];
    ...
    public function in_artikel()
    {
		...
		$gambar = $this->do_upload('gambar','./data/artikel/');
    ...
    public function up_artikel()
    {
		...
		$up = $this->ma->upArtikel($obj,['id' => $id]);
		if ($up) {
            $status = true;
    ...
    public function set_nonaktif($id)
	{
		...
		$x = $this->ma->upArtikel($data,['id' => $id]);
